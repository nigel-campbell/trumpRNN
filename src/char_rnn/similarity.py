"""
Script to detect similarity between autoencoder model of a text and a text provided as input to the script. 

Provides a similarity score (percentage) indicating similarity of style and content.
